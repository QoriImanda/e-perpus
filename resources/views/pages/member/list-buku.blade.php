        ...
        <div class="col-12">
            <div class="card">
                <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="custom-content-below-list-buku-tab" data-toggle="pill"
                            href="#tab-list-buku" role="tab" aria-controls="tab-list-buku" aria-selected="true">List
                            Buku</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="custom-content-below-peminjaman-tab" data-toggle="pill"
                            href="#list-peminjaman" role="tab" aria-controls="list-peminjaman"
                            aria-selected="false">Peminjaman</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="custom-content-below-pengembalian-tab" data-toggle="pill"
                            href="#list-pengembalian" role="tab" aria-controls="list-pengembalian"
                            aria-selected="false">Pengembalian</a>
                    </li>
                </ul>
                <div class="card-body">
                    <div class="tab-content" id="custom-content-below-tabContent">
                        <div class="tab-pane fade show active" id="tab-list-buku" role="tabpanel"
                            aria-labelledby="custom-content-below-list-buku-tab">
                            <div class="row mb-3">
                                <div class="col-md-10">
                                ...
                                <div class="col-md-2">
                                    <button type="button" class="btn btn-primary btn-search col-12 btn-search mt-2"><i
                        ...
                        <div class="tab-pane fade" id="list-peminjaman" role="tabpanel"
                            aria-labelledby="custom-content-below-peminjaman-tab">
                        ...
                        <div class="tab-pane fade" id="list-pengembalian" role="tabpanel"
                            aria-labelledby="custom-content-below-pengembalian-tab">
                            ...
                            <div class="card card-primary card-outline">
                                <div class="card-body box-profile">
                                    <div class="text-center">
                                        <img class="profile-user-img img-fluid img-circle detail-gambar" src=""
                                            alt="Not Found">
                                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="d-flex justify-content-center">
                        <img src="{{ asset('/Image/warning.png') }}" alt="" class="d-block"
                    ...
                    <div class="d-flex justify-content-justify">
                        <p>Saat Peminjaman Buku, Wajib Memberikan <b>KTP</b> atau <b>Kartu Tanda Pengenal Lain</b> Sebagai
                            Jaminan untuk Dilakukan Verifikasi Peminjaman oleh Petugas Perpustakaan. Bersediakah Anda ?</p>
                    </div>
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
    ...
    <div class="modal fade" id="modal-kembali">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="d-flex justify-content-center">
                        <img src="" alt="" class="d-block image-modal-pengembalian"
                            style="height: 100px; width: 110px;">
                    </div>
                    <div class="d-flex justify-content-center">
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        if (res.data.length != 0) {
                            ...
                            $('.detail-jumlah-halaman').html(res.data.jumlah_halaman +
                                ' Halaman');
                    ...
                    success: function(res) {
                        if (res.status == 200) {
                            if (res.type == 1) {
                                ...
                                $('.message-check-denda').html(res.message);
                                $('.simpan-kembalikan-buku').removeClass('d-none').addClass(
                                    'd-block');
                            }
