        ...
        <div class="card w-100">
            ...
            <div class="card-body">
                ...
                <div class="row">
                        ...
                        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img class="d-block w-100" src="{{ asset('Image/Dashboard/1.jpg') }}" alt="First slide"
                                        style="width: 500px;height:300px">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="{{ asset('Image/Dashboard/2.jpg') }}" alt="Second slide"
                                        style="width: 500px;height:300px">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="{{ asset('Image/Dashboard/3.jpg') }}" alt="Third slide"
                                        style="width: 500px;height:300px">
                                </div>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="card-body">
                            <canvas id="donutChart" class="mb-2"
...
@push('script')
    <script>
        $(document).ready(function() {
            ...
            $('#caption-chart').html(banyak_chart + ' Jenis Kategori Terbanyak Digunakan Buku').addClass(
                'font-weight-bold');
            ...
            var areaChartData = {
                labels: ['Januari', 'Februari', 'Maret', 'April', 'Mey', 'Juni', 'Juli', 'Agustus', 'September',
