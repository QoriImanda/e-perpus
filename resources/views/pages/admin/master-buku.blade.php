                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-2 mt-3">
                            <a href="{{ route('admin.master-template-import-buku') }}" class="btn btn-warning"
                                style="width: 100%" title="Download Template"><i class="fas fa-download"></i></a>
                        </div>

                        <div class="col-lg-8 mt-3">
                            <form action="{{ route('admin.master-import-buku') }}" method="post"
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" id="excel"
                                                name="file_excel">
                                            <label class="custom-file-label" for="excel" id="nama_excel">Upload
                                                Excel</label>
                                        </div>
                        ...
                        <div class="col-lg-2 mt-3">
                            <button type="submit" class="btn btn-success" style="width: 100%" title="Upload Excel"><i
                ...
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <div class="d-flex justify-content-between">
                            {{-- <a href="{{ route('admin.master-export-buku') }}" class="btn btn-success btn-sm mr-1"><i
                            ...
                            <tbody>
                                @forelse($buku as $row)
                                    <tr>
                                        ...
                                        @else
                                            <td class="text-center"><img src="{{ asset('/Image/Buku/' . $row->gambar) }}"
                                                    alt="Not Found" style="height: 100px; width: 150px;"></td>
                                        @endif
                                        <td>{{ $row->judul }}</td>
                                        <td>{{ $row->isbn }}</td>
                                        ...
                                        <td>
                                            <div class="row">
                                                <div class="col-12 d-flex justify-content-center">
                                                    <a href="{{ route('admin.master-detail-buku', base64_encode($row->id)) }}"
                                                        title="Detail"
                                                        class="btn btn-info btn-sm mt-1 mb-1 ml-1 mr-1 btn-detail-buku disabled"
                                                        disabled><i class="fas fa-eye"></i></a>
                                                    <a href="{{ route('admin.master-edit-buku', base64_encode($row->id)) }}"
                                                        title="Edit"
                                                        class="btn btn-warning btn-sm mt-1 mb-1 ml-1 mr-1 btn-edit-buku disabled"
                                                        disabled><i class="fas fa-pen"></i></a>
                                                    <button type="button" title="Hapus"
                                                        data-id="{{ base64_encode($row->id) }}"
                                                        class="btn btn-danger btn-sm mt-1 mb-1 ml-1 mr-1 btn-delete-buku disabled"><i
                                                            class="fas fa-trash" disabled></i></button>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
