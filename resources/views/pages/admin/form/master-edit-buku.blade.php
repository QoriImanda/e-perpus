    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{ route('admin.master-update-buku', base64_encode($buku->id)) }}" method="post"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="judul" name="judul"
                                value="{{ old('judul', $buku->judul) }}" placeholder="Masukkan Judul">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="pengarang" name="pengarang"
                                value="{{ old('pengarang', $buku->pengarang) }}" placeholder="Masukkan Pengarang">
                        </div>
                        <div class="form-group">
                            <label for="jumlah_halaman">Jumlah Halaman</label>
                            <input type="number" min="0" onkeypress="return /[0-9]/i.test(event.key)"
                                class="form-control" id="jumlah_halaman" name="jumlah_halaman"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" min="0" onkeypress="return /[0-9]/i.test(event.key)"
                                class="form-control" id="jumlah_stok" name="jumlah_stok"
                                value="{{ old('jumlah_stok', $buku->jumlah_stok) }}" placeholder="Masukkan Jumlah Stok">
                        </div>
                        <div class="form-group">
                            <label for="tahun_terbit">Tahun Terbit</label>
                            <input type="date" min="0" onkeypress="return /[0-9]/i.test(event.key)"
                                class="form-control" id="tahun_terbit" name="tahun_terbit"
                                value="{{ old('tahun_terbit', $buku->tahun_terbit) }}" placeholder="Masukkan Tahun Terbit">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="d-flex justify-content-center mt-2">
                                <img src="{{ '/Image/Buku/' . $buku->gambar }}" alt="Not Found" class=""
                            ...
                            <div class="input-group">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" name="img" id="gambar"
                            ...
                            <div class="form-group">
                                <label for="exampleInputFile">E-Book</label>
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" name="file" id="file"
                                            accept=".pdf">
                                        <label class="custom-file-label" for="file" id="nama_file">Ganti file</label>
                                    </div>
                                    <div class="input-group-append">
                                        <span class="input-group-text">Upload</span>
                                    </div>
